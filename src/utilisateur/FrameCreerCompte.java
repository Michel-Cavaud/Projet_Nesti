...
public class FrameCreerCompte {
	...
	private int[] pos = {50, 130, 210, 290, 370, 450, 530};
	...
	private void initialize() {
		...
		frmCreerCompte.setBounds(100, 100, 380, 800);
		frmCreerCompte.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		panel_principal.setBounds(0, 0, 380, 800);
	...
	private void message() {
		...
		message.setBounds(0, 617, 380, 32);
	...
	private void boutonSubmit() {
		...
		lblNewLabel_8.setBounds(0, 660, 380, 48);
		lblNewLabel_8.addMouseListener(new MouseAdapter() {

			public void mouseClicked(MouseEvent e) {
				if(!listInput.get("mdp").equals(listInput.get("mdp1"))){
		...
		lblNewLabel_9.setBounds(0, 660, 380, 48);
		img = null;
		try {
	...
	private void lien() {
		...
		creerCompte.setBounds(0, 710, 380, 32);
